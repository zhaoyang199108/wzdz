...
<div class="wrapper">
			...
			<div class="wrap_right">
				...
				<div class="wr_box_tit">
					事项类别-${not empty bsznType.id?'修改':'添加'}
				</div>
				<div class="wr_box_fgx"></div>
				<div class="csmp_xg_form">
				<form:form id="form" modelAttribute="bsznType" action="${pageContext.request.contextPath}/bsznType/updateType" method="post">
					<form:hidden path="id"/>
					<div class="csmp_xg_b1">
						...
						<form:select path="parentId">
							...
							<option value="1" <c:if test="${bsznType.parentId==1 }"> selected </c:if>>事项分类</option>
							
							<option value="2" <c:if test="${bsznType.parentId==2 }"> selected </c:if>>部门分类</option>
						</form:select>
					...
					<div class="csmp_xg_b1">
						...
						<form:input path="name" class="csmp_xg_input1"/>
					</div>
